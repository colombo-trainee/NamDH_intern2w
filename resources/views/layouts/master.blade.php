                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <img alt="" class="img-circle" src="@if(!empty(Auth::user()->avatar)) {{url('img/default_avatar.jpg')}}@endif" />

                          
                                <span class="username username-hide-on-mobile" id="id_login" data-id="@if(!empty(Auth::user()->id)) {{ Auth::user()->id }} @endif">  @if(!empty(Auth::user()->name))  {{ Auth::user()->name }} @endif</span>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    @if (Auth::guard('web')->check() && !Request::is('students*'))
                        ...
                        <!-- START CATE -->
                           <li class="nav-item {{ Request::is('list-menu*') ? 'active open' : '' }}  ">
                                <a href="{{ route('list-menu.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-book"></i>
                                    <span class="title">Quản Lý Danh Mục Món Ăn</span>
                                </a>
                            </li>

                        <!-- START FOOD-->
                           <li class="nav-item {{ Request::is('list-food*') ? 'active open' : '' }}  ">
                                <a href="{{ route('list-food.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-book"></i>
                                    <span class="title">Quản Lý Các Món Ăn</span>
                                </a>
                            </li>

                         <!-- START BOOK TABLE-->
                           <li class="nav-item {{ Request::is('book-tables*') ? 'active open' : '' }}  ">
                                <a href="{{ route('book-tables.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-book"></i>
                                    <span class="title">Quản Lý Lịch Đặt Bàn</span>
                                </a>
                            </li>
                        <!-- START BOOK TABLE-->
                           <li class="nav-item {{ Request::is('book-tables*') ? 'active open' : '' }}  ">
                            ...
                            {{-- <li class="nav-item {{ Request::is('feedbacks*') ? 'active open' : '' }}  ">
                                <a href="{{ route('feedbacks') }}" class="nav-link nav-toggle">
                            ...
                            <!-- START POST -->
                            {{-- <li class="nav-item  {{ Request::is('tintuc*') ? 'active open' : '' }}">
                                <a href="{{ url('tintuc/danhsach')}}" class="nav-link nav-toggle">
                                ...
                                @foreach ($classes as $class)
                                    <li class="nav-item  ">
                                        <a href="javascript:;" class="nav-link nav-toggle">
                                            <span class="title"><i class="fa fa-graduation-cap" aria-hidden="true"></i> {{$class->ClassRoom->class_name}}</span>
                                            <span class="arrow"></span>
                                        </a>
                                        <ul class="sub-menu">
                                            <li class="nav-item ">
                                                <a href="{{URL::asset('')}}students/class-room/{{$class->class_room_id}}" class="nav-link "> Danh sách bài học </a>
                                            </li>
                                            <li class="nav-item ">
                                                <a href="#" class="nav-link "> Bảng xếp hạng </a>
                                            </li>
                                            <li class="nav-item ">
                                                <a href="{{$class->facebook_group}}" class="nav-link "> Facebook </a>
                                            </li>
                                        </ul>
                                    </li>
                                @endforeach
...
<!-- Include Date Range Picker -->
        ...
        <script>
            $(document).ready(function(){
                var date_input=$('input[name="editOriantationTime"]'); //our date input has the name "date"
                var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
                date_input.datepicker({
                    format: 'yyyy/mm/dd',
                    container: container,
