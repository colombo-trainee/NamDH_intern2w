...
<div class="portlet-title">
    <div class="caption uppercase">
        <i class="fa fa-book"></i> Quản lý Category Menu </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"> {{ $category->describe }} </td>
                    ...
                    <td class="text-center"> 
                        <a href="{{route('list-menu.show', $category->name)}}" class="btn btn-outline btn-circle btn-sm blue">
                            <i class="fa fa-eye" aria-hidden="true"></i> Xem 
                        </a>
                        <a href="{{route('list-menu.edit', $category->id)}}" class="btn btn-outline btn-circle green btn-sm purple">
...
<script>
 function alertDel(id){
  ...
  var path = "{{URL::asset('')}}/admin/list-menu/" + id;
...
@section('footer')
 ...
 <script>
     function addCourse() {
         window.location = "{{route('list-menu.create')}}"
     }
 </script>
@endsection