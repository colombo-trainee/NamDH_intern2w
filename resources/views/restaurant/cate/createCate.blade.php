...
<div class="portlet light bordered" id="form_wizard_1">
   <div class="portlet-title">
      <div class="caption">
         <span class="caption-subject font-red bold uppercase"><i class="fa fa-plus-circle" aria-hidden="true"></i> TẠO MỚI DANH MỤC MENU  </span>
      </div>
   </div>
  ...
  {{--  @if(count($errors))
    ...
    @endif --}}
      <form  action="{{route('list-menu.store')}}" id="frmCreateCourse" name="frmCreateCourse" method="POST" enctype="multipart/form-data" autocomplete="off">
         {{ csrf_field() }}
                     ...
                     <div class="form-body col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="form-group">
                            <div style="margin-bottom: 15px;color: #888;">Mô tả</div>
                              <textarea class="form-control" rows="3" id="describe" name="describe" placeholder="Nội Dung">{{ old('describe') }}</textarea>
