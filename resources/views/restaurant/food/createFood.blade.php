...
<div class="portlet light bordered" id="form_wizard_1">
   <div class="portlet-title">
      <div class="caption">
         <span class="caption-subject font-red bold uppercase"><i class="fa fa-plus-circle" aria-hidden="true"></i> CREATE A FOOD  </span>
      </div>
   </div>
  ...
  {{--  @if(count($errors))
    ...
    @endif --}}
      <form  action="{{route('list-food.store')}}" name="frmCreateFood" method="POST" enctype="multipart/form-data" autocomplete="off">
         {{ csrf_field() }}
                     ...
                     <div class="form-body col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1">
                      {{-- Name --}}
                        <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('name') ? 'has-error' : '' }}">
                           ...
                           <label for="name">Name of food <span class="requireds"> (*)</span></label>
                        </div>
                      ...
                      {{-- images --}}
                         <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('images') ? 'has-error' : '' }}">
                          <label for="images" style="margin-bottom: 15px;color: #888;">Images</label>
                      ...
                      {{-- Ingredients --}}
                        <div class="form-group">
                            <div style="margin-bottom: 15px;color: #888;">Ingredients</div>
                              <textarea class="form-control" rows="3" id="ingredients" name="ingredients" placeholder="Nội Dung">{{ old('ingredients') }}</textarea>
